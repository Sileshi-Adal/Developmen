 ...
 "cells": [
  {
   ...
   "metadata": {},
   "source": [
    "# Uma's and Shams' Reviewed by Zeynel and Sileshi"
   ]
  },
  {
   "cell_type": "markdown",
  ...
  },
  {
   ...
   "metadata": {},
   "source": [
    "They explained the 5 things that why the Kaggle Kernel is useful and also they discibed what can be done in pandas"
   ]
  }
 ],
 "metadata": {
